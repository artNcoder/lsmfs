...
# Single threaded asynchronous random writes (2KB I/Os) on a 1GB file.
# A fsync is issued after 10000 ($iters) worth of writes.
# Stops after one ($count) fsync.

#set $dir=/data/HDD_Sdc_XFS_data/microwrites_rw_fsync
#set $dir=/data/HDD_Sdd_data/microwrites_rw_fsync
set $dir=/data/HDD_Sdd_data/lsmfs_test8
set $cached=false
set $count=1
set $filesize=1g
set $iosize=2k
